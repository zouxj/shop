...
public class CountdownView extends View {
    protected BaseCountdown mCountdown;
    protected CustomCountDownTimer mCustomCountDownTimer;
    protected OnCountdownEndListener mOnCountdownEndListener;
    protected OnCountdownIntervalListener mOnCountdownIntervalListener;

    protected boolean isHideTimeBackground;
    protected long mPreviousIntervalCallbackTime;
     ...
     * @return measureSize
     */
    protected int measureSize(int specType, int contentSize, int measureSpec) {
        int result;
...
//
    ...
    protected void reSetTime(long ms) {
        int day = 0;
        int hour;
