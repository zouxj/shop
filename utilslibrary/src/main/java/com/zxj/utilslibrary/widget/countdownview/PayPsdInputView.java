...
public class PayPsdInputView extends EditText {
     ...
     * 底部线的颜色   默认GRAY
     */
    private int bottomLineColor = UIUtil.getColor(R.color.color_ddd);

    /**
     * 分割线的颜色
     */
    private int borderColor =  UIUtil.getColor(R.color.color_ddd);
    /**
     * 分割线的画笔
     */
    ...
    private onInputPasswordListener mOnInputListner;
...
//        canvas.drawRoundRect(focusedRecF, rectAngle, rectAngle, getPaint(3, Paint.Style.STROKE, focusedColor));
    ...
    public interface onInputPasswordListener {
            void onInputListner(String str);
    }
}
