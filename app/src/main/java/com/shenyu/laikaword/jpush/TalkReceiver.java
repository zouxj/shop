...
//            channel = extrasJson.optString(SyncStateContract.Constants.KEY_CHANNEL);
//        } catch (Exception e) {
...
//            Intent msgIntent = new Intent(TestMainActivity.MESSAGE_RECEIVED_ACTION);
