package com.shenyu.laikaword.ui.view.widget.expandtextview;
...
public class ExpandTextView extends LinearLayout implements View.OnClickListener {
    ...
    public ExpandTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        titleTextSize = a.getDimension(R.styleable.ExpandTextView_titleTextSize, UIUtil.sp2px(mContext, DEFAULT_TITLE_TEXT_SIZE));
        contentTextSize = a.getDimension(R.styleable.ExpandTextView_contentTextSize, UIUtil.sp2px(mContext, DEFAULT_CONTENT_TEXT_SIZE));
        hintTextSize = a.getDimension(R.styleable.ExpandTextView_hintTextSize, UIUtil.sp2px(mContext, DEFAULT_HINT_TEXT_SIZE));
    ...
    private void init() {
        ...
        if (indicateImage == null) {
            indicateImage = UIUtil.getDrawable(R.mipmap.index_more);
        }
    ...
    public void setTitleTextSize(float titleTextSize) {
        this.titleTextSize = UIUtil.sp2px(mContext, titleTextSize);
    ...
    public void setContentTextSize(float contentTextSize) {
        this.contentTextSize = UIUtil.sp2px(mContext, contentTextSize);
    ...
    public void setHintTextSize(float hintTextSize) {
        this.hintTextSize = UIUtil.sp2px(mContext, hintTextSize);
    ...
    public int getMinMeasureHeight() {
        if (copy == null) {
            ...
            copy.setLineSpacing(UIUtil.dp2px( 6), 1.0f);
