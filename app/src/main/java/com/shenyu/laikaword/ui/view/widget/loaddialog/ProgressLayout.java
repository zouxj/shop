package com.shenyu.laikaword.ui.view.widget.loaddialog;
...
public class ProgressLayout extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        loadingStateProgressBarWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_loadingProgressBarWidth, 108);

        loadingStateProgressBarHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_loadingProgressBarHeight, 108);
        ...
        emptyStateContentTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_emptyContentTextColor, getResources().getColor(R.color.lightgray));
     ...
     */
    public void showEmpty(int emptyImageDrawable, String text) {
        switchState(EMPTY, emptyImageDrawable, null, text, null, null, Collections.<Integer>emptyList());
    }
    ...
    public void showEmpty(int emptyImageDrawable, String text, OnClickListener listener){
        switchState(EMPTY,emptyImageDrawable,null,text,null,listener, Collections.<Integer>emptyList());
    }
    ...
    public void showError(OnClickListener onClickListener){
        showError(0,null,"网络不可用，请检查网络设置~","刷新",onClickListener);
    }
